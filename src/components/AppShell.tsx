  ...
  return (
    <div className="min-h-dvh bg-canvas text-slate-800">
      <header className="sticky top-0 z-10 border-b border-[#2D3748] bg-[#1E2533]">
        <div className="mx-auto flex w-full flex-col gap-y-3.5 px-4 py-3.5 md:px-8">
          ...
          <div className="flex w-full items-center justify-between gap-4">
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div className="leading-tight shrink-0">
                <div className="text-lg font-semibold tracking-wide text-[#E2E8F0] whitespace-nowrap">ICU 護理分配決策支援系統</div>
              </div>
            </div>
          ...
          {/* Row 2: Nav Links */}
          <nav className="flex w-full items-center gap-1.5 overflow-x-auto scrollbar-none py-1 justify-start lg:justify-center border-t border-[#2D3748]/55 pt-3">
